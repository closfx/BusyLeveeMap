...
THREE.OrbitAndPanControls = function ( object, domElement ) {
	...
	// columns ( te[8], te[9], te[10] ) - pan up translates to dolly in/out ( z-axis )
	...
	this.pan = function ( delta ) {
		...
		if ( scope.object.fov !== undefined )
		{
			...
			scope.panLeft( 2 * delta.x * targetDistance / scope.domElement.height / 2 );
			scope.panUp( 2 * delta.y * targetDistance / scope.domElement.height / 4 );
		}
